...
const Pokemon = () => {
  ...
  useEffect(() => {
    ...
    if (imageId !== undefined && images[imageId]) {
      imageElemet.src = images[imageId];
    } else {
      imageElemet.src = defaultImages[imageId]; // Fallback to default image
    }
  ...
  return (
    <div>
      ...
      {currentPokemonTab === pokemonTabs.locations && <Catching />}
